<template>
    ...
    <div class="text-left text-gray-900 dark:text-white">
        ...
        <p class="mt-2">
            <span class="font-bold block">Vertreten durch</span>
            Chloe Matter
        </p>
        <p class="mt-2">
            <span class="font-bold block">Kontakt</span>
            E-Mail: <a href="mailto:zchloe@strilon.net" target="_blank">admins@strilon.net</a>
        </p>
        ...
        <p class="mt-2">
            <span class="font-bold block">Haftung für Inhalte</span>
        ...
        <p class="mt-2">
            <span class="font-bold block">Haftung für Links</span>
        ...
        <p class="mt-2">
            <span class="font-bold block">Urheberrecht</span>
        ...
        <p class="mt-2">
            <span class="font-bold block">Datenschutz</span>
